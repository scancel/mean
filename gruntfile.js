module.exports = function ( grunt ) {
    ...
    var taskConfig = {
        ...
        delta: {
            ...
            /**
             * When our JADE templates change, we want to compile
             * run our unit tests.
             */
            jade: {
                files: ['app/views/**']
    ...
    grunt.registerMultiTask( 'index', 'Process index.html template', function () {
        ...
        grunt.file.copy('public/src/index.html', this.data.dir + '/index.html', {
    ...
    grunt.registerMultiTask( 'karmaconfig', 'Process karma config templates', function () {
        ...
        grunt.file.copy( 'public/karma/karma-unit.tpl.js', grunt.config( 'build_dir' ) + '/karma-unit.js', {
            process: function ( contents, path ) {
                return grunt.template.process( contents, {
                    data: {
                        scripts: jsFiles
